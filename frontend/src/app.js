...
const state = {
    ...
    dagCanvasRenderer: null, // Active Canvas renderer instance
};
...
function addStyles() {
    ...
    /* DAG Canvas Container (for Canvas renderer) */
...
export function initApp() {
    // Initialize DAG module with shared state
    initDAGModule(state, escapeHtml);
    registerGlobals();
